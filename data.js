...
const INFO = {
  Helsinki: {
    ...
    tips: "Itinerary locations in bold are saved on Google Maps.",
  },
  Tallinn: {
    currency: "Euro (€)",
  ...
  Oslo: {
    ...
    tips: "Tipping isn't mandatory — bill usually includes service. Weather is unpredictable — bring a rain jacket.",
  },
  Bergen: {
    ...
    tips: "Cruise ships in port Jun 23–24 — visit Bryggen/Fløyen after 5 PM once they depart for a quieter experience.",
  },
};
