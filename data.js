...
const DAYS = [
  { date: "2026-06-09", city: "In Flight", title: "Depart Washington", blocks: [
    { time: "5:20 PM", timeEnd: "7:20 AM", icon: "flight", title: "Depart IAD for Frankfurt", resId: "flightOut", blurb: "Wheels up — the first leg of the trip, Washington to Frankfurt overnight." },
  ]},
  ...
  { date: "2026-06-10", city: "Helsinki", title: "Arrival Day",
    ...
    blocks: [
      { time: "9:40 AM", timeEnd: "1:10 PM", icon: "flight", title: "Connect FRA → HEL", resId: "flightOut", blurb: "A short connection through Frankfurt, then on into Finland." },
  ...
  { date: "2026-06-11", city: "Helsinki", title: "Synagogue & Private Tour",
    ...
    blocks: [
      { time: "10:00 AM", timeEnd: "11:00 AM", icon: "activity", title: "Helsinki Synagogue Tour", detail: "10:00–11:00 AM · €10pp donation · Malminkatu 26 · srk@jchelsinki.fi. A significant symbol of Jewish culture and community in the Finnish capital — one of just two synagogues in Finland, serving Helsinki's 1,200-member Jewish community. Built in 1906.", mapQuery: "Helsinki Synagogue" },
      { time: "11:15 AM", timeEnd: "3:15 PM", icon: "tour", title: "Private Highlights & Hidden Gems", resId: "tourHelsinkiLocals", blurb: "A private, local's-eye look at Helsinki beyond the guidebook stops. Meeting point: Stockmann Department Store main entrance, under the large clock." },
  ...
  { date: "2026-06-13", city: "Tallinn", title: "Day Trip to Estonia",
    ...
    blocks: [
      { time: "7:30 AM", timeEnd: "9:30 AM", icon: "ferry", title: "Ferry to Tallinn", resId: "ferryTallinn", blurb: "A 2-hour crossing on a 10-deck ferry — pub, viewing deck and duty-free on board. Check in by 7:00 AM at West Terminal 2." },
      { time: "10:00 AM", timeEnd: "1:00 PM", icon: "tour", title: "Private Highlights & Hidden Gems", resId: "tourTallinnLocals", blurb: "A local's walk through the UNESCO Old Town — cobblestones, city walls, hidden courtyards. Meeting point: Freedom Square in front of Jaani Kirik church." },
      { time: "4:30 PM", timeEnd: "6:30 PM", icon: "ferry", title: "Return ferry to Helsinki", resId: "ferryTallinn", blurb: "Same crossing back. Check in to Tallinn D-Terminal by 16:00." },
    ]},
  ...
  { date: "2026-06-14", city: "Stockholm", title: "Fly to Sweden",
    ...
    blocks: [
      ...
      { time: "12:00 PM", timeEnd: "3:00 PM", icon: "tour", title: "Private City Tour, Gamla Stan", resId: "tourStockholmLocals", blurb: "First steps into Sweden — Stockholm's 700-year-old old town, medieval alleys and all. Meeting point: in front of Stockholms Gästabud restaurant, Österlånggatan 7." },
  ...
  { date: "2026-06-15", city: "Stockholm", title: "Gamla Stan & Fika",
    ...
    blocks: [
      { time: "9:00 AM", timeEnd: "11:00 AM", icon: "tour", title: "Stockholm Full City — Multi Island", resId: "tourStockholmMultiIsland", blurb: "Gamla Stan cobblestone streets, medieval buildings, and historic sites, founded 1252. Meeting point: Skeppsbron 25, Gamla Stan." },
  ...
  { date: "2026-06-16", city: "Stockholm", title: "Vasa Museum & ABBA",
    ...
    blocks: [
      { time: "10:00 AM", timeEnd: "12:30 PM", icon: "tour", title: "Vasa Museum Small-Group Tour", resId: "tourVasaMuseum", blurb: "The world's only surviving 17th-century warship — raised intact after 333 years underwater. One of the biggest cultural treasures in Sweden." },
      ...
      { time: "3:00 PM", timeEnd: "5:00 PM", icon: "activity", title: "ABBA The Museum", detail: "Timed entry (3:00–3:30 PM), reservation needed. Dance with ABBA! QR audio guided tour, ABBA Karaoke. Very interactive museum.", mapQuery: "ABBA The Museum, Stockholm" },
      { time: "8:00 PM", timeEnd: "9:30 PM", icon: "activity", title: "Brad Paisley Concert at Gröna Lund", detail: "8:00–9:30 PM at Gröna Lund amusement park.", mapQuery: "Grona Lund, Stockholm" },
    ]},
  ...
  { date: "2026-06-17", city: "Stockholm", title: "Archipelago & Vikings",
    ...
    blocks: [
      { time: "9:30 AM", timeEnd: "11:30 AM", icon: "tour", title: "Stockholm Archipelago Speedboat", resId: "tourArchipelago", blurb: "Exploring the traditional summer getaway of locals on the Stockholm Peninsula, viewing historic sites and summer houses dating to the 17th century. Meeting point: Pier 19 (Kajplats 19), Strandvägen 20–28." },
      { time: "1:00 PM", timeEnd: "3:30 PM", icon: "tour", title: "Viking History Walking Tour", resId: "tourVikingWalk", blurb: "Meeting point: Stortorget in front of Nobel Museum. Arrive 10 minutes early." },
    ]},
  ...
  { date: "2026-06-18", city: "Stockholm", title: "Royal Palace & Metro Art",
    ...
    blocks: [
      { time: "11:45 AM", timeEnd: "1:15 PM", icon: "activity", title: "Royal Palace — 90 min Guided Tour", detail: "Stockholm Pass guided tour of opulent Royal Apartments, Treasury, and Royal Chapel.", mapQuery: "Royal Palace Stockholm" },
      { time: "12:15 PM", timeEnd: "12:55 PM", icon: "activity", title: "Changing of the Guard", detail: "Outer courtyard parade and band at 12:15 PM, takes 40 minutes. Band/guards march through central Stockholm to the palace starting at 11:45 AM — view from Skeppsbron water side of palace." },
  ...
  { date: "2026-06-20", city: "Oslo", title: "Royal Palace & Harbor",
    blocks: [
      ...
      { time: "1:30 PM", timeEnd: "2:10 PM", icon: "activity", title: "Changing of the Guard", detail: "40-minute ceremony at the Royal Palace." },
  ...
  { date: "2026-06-22", city: "Bergen", title: "Norway in a Nutshell — Fjord Crossing",
    ...
    blocks: [
      ...
      { time: "1:15 PM", timeEnd: "2:30 PM", icon: "tour", title: "Stegastein Viewpoint — Private Tour", resId: "tourStegastein", blurb: "A platform 2,000+ feet above the Aurlandsfjord — higher than the World Trade Center. Booking #3097." },
...
const EXPLORE = {
  Helsinki: [
    ...
    { name: "Kamppi Chapel — Chapel of Silence", tag: "Architecture", day: "2026-06-10",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2b/Chapel_of_Silence_in_Helsinki.jpg/960px-Chapel_of_Silence_in_Helsinki.jpg", mapQuery: "Kamppi Chapel, Helsinki" },
    { name: "Hakaniemi Market Hall", tag: "Market", day: "2026-06-10",
      desc: "Old Market Hall — central market near Market Square & Harbor.",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Hakaniemen_kauppahalli2008.jpg/960px-Hakaniemen_kauppahalli2008.jpg", mapQuery: "Hakaniemi Market Hall, Helsinki" },
    { name: "Design Museum Helsinki", tag: "Design", day: "2026-06-11",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Ateneum_main_facade.jpg/960px-Ateneum_main_facade.jpg", mapQuery: "Design Museum Helsinki" },
    ...
    { name: "Allas Sea Pool", tag: "Experience", day: "2026-06-12",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Allas_Sea_Pool_Helsinki_1.jpg/960px-Allas_Sea_Pool_Helsinki_1.jpg", mapQuery: "Allas Sea Pool, Helsinki" },
    { name: "Tavastia — Legendary Music Venue", tag: "Music", day: "2026-06-12",
      desc: "One of Europe's oldest rock clubs, near Amos Rex.",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Tavastia.jpg/960px-Tavastia.jpg", mapQuery: "Tavastia Club, Helsinki" },
    { name: "Paja Workshop", tag: "Crafts", day: "2026-06-12",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Kamppi_Center_II.jpg/960px-Kamppi_Center_II.jpg", mapQuery: "Paja Workshop Eerikinkatu 18 Helsinki" },
    ...
    { name: "Tram #2 — Sightseeing Loop", tag: "Transport",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Tram_Helsinki_-_line_7%2C_Helsinki_Harbor.jpg/960px-Tram_Helsinki_-_line_7%2C_Helsinki_Harbor.jpg", mapQuery: "Helsinki tram" },
  ],
  ...
  Tallinn: [
    ...
    { name: "Raeapteek — 600-Year-Old Pharmacy", tag: "History",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Tallinna_Raeapteek%2C_14.-20.saj.jpg/960px-Tallinna_Raeapteek%2C_14.-20.saj.jpg", mapQuery: "Raeapteek, Tallinn" },
    { name: "Calamaya Area & KGB Prison Cells", tag: "History",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Tallinn%2C_hoone%2C_kus_on_paiknenud_Eesti_riigikaitseasutused_ja_v%C3%B5%C3%B5rv%C3%B5imude_julgeolekuorganid_%282%29.jpg/960px-Tallinn%2C_hoone%2C_kus_on_paiknenud_Eesti_riigikaitseasutused_ja_v%C3%B5%C3%B5rv%C3%B5imude_julgeolekuorganid_%282%29.jpg", mapQuery: "Kalamaja, Tallinn" },
    { name: "Olde Hansa Restaurant", tag: "Dining",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Restaurante_Olde_Hansa_%28Tallin%29_02.jpg/960px-Restaurante_Olde_Hansa_%28Tallin%29_02.jpg", mapQuery: "Olde Hansa, Tallinn" },
  ],
  ...
  Stockholm: [
    ...
    { name: "Storkyrkan — Stockholm Cathedral", tag: "Historic", day: "2026-06-15",
      desc: "The mother church of Stockholm, dating to the 1300s — site of royal weddings and the annual opening of parliament.",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Storkyrkan_Stockholm_2012a.jpg/960px-Storkyrkan_Stockholm_2012a.jpg", mapQuery: "Storkyrkan, Stockholm" },
    ...
    { name: "Skansen — Open-Air Museum", tag: "Museum", day: "2026-06-16",
      desc: "The world's oldest open-air museum — five centuries of Swedish life, unique gardens, cafes and culturally significant buildings.",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Skansen%2C_Stockholm_%28by_Pudelek%29_3.JPG/960px-Skansen%2C_Stockholm_%28by_Pudelek%29_3.JPG", mapQuery: "Skansen, Stockholm" },
    ...
    { name: "Drottningholm Palace", tag: "Add-On",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Drottningholm_Palace_-_panorama_september_2011.jpg/960px-Drottningholm_Palace_-_panorama_september_2011.jpg", mapQuery: "Drottningholm Palace, Stockholm" },
    { name: "Golden Hits — Dinner Show", tag: "Add-On",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Gr%C3%B6na_lund_01.jpg/960px-Gr%C3%B6na_lund_01.jpg", mapQuery: "Golden Hits Stockholm" },
    { name: "City Hall", tag: "Add-On",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Stockholms_stadshus_september_2011.jpg/960px-Stockholms_stadshus_september_2011.jpg", mapQuery: "Stockholm City Hall" },
    ...
    { name: "SoFo / Södermalm", tag: "Add-On",
      desc: "Hip district filled with vintage stores, design boutiques, galleries and trendy cafes.",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Folkungagatan_2008.jpg/960px-Folkungagatan_2008.jpg", mapQuery: "SoFo Sodermalm, Stockholm" },
    { name: "Mariatorget", tag: "Add-On",
      desc: "Square in Södermalm surrounded by cafes — a relaxing location to experience local neighborhood vibes.",
      img: "https://upload.wikimedia.org/wikipedia/commons/9/93/Emanuel_Swedenborg_Mariatorget_Stockholm_2005-06-29.jpg", mapQuery: "Mariatorget, Stockholm" },
    { name: "Nobis Hotel", tag: "Add-On",
      desc: "Former bank — the present locker room vault area is where the 1970 robbery hostages became sympathetic with the robbers, which became known as \"Stockholm Syndrome\".",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Norrmalmstorg_mot_%C3%B6st_2012.jpg/960px-Norrmalmstorg_mot_%C3%B6st_2012.jpg", mapQuery: "Nobis Hotel, Stockholm" },
    { name: "Mårten Trotzigs Gränd", tag: "Add-On",
      desc: "Smallest alley in Gamla Stan — graffiti art walls.",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Marten-Trotzigs-Graend.jpg/960px-Marten-Trotzigs-Graend.jpg", mapQuery: "Marten Trotzigs Grand, Stockholm" },
    { name: "Strandvägen", tag: "Add-On",
      desc: "Premier address waterfront boulevard — grand 19th century architecture.",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/D810_0103_%2815071560842%29.jpg/960px-D810_0103_%2815071560842%29.jpg", mapQuery: "Strandvagen, Stockholm" },
  ],

  Oslo: [
    // Scheduled day items (Steve Sep 5 item 9 — were missing entirely)
    { name: "Fram Museum", tag: "Museum", day: "2026-06-21",
      desc: "1½ hr, Oslo Pass. The original arctic and Antarctic expedition ship used by explorer Roald Amundsen, the first person to reach the South Pole.",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Oslo%2C_Fram_museum%2C_Fram_ship_%2802%29.jpg/960px-Oslo%2C_Fram_museum%2C_Fram_ship_%2802%29.jpg", mapQuery: "Fram Museum, Oslo" },
    { name: "Kon-Tiki Museum", tag: "Museum", day: "2026-06-21",
      desc: "1½ hr, Oslo Pass. Right next door to the Fram Museum, on Bygdøy / Museum Island.",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/The_Kon-Tiki_Museum%2C_Oslo.jpg/960px-The_Kon-Tiki_Museum%2C_Oslo.jpg", mapQuery: "Kon-Tiki Museum, Oslo" },
    // Add-On Options (no day field)
    ...
    { name: "Damstredet & Telthusbakken", tag: "Neighborhood",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Fredensborg_nedre_hukebak_IMG_0153_rk_166586.JPG/960px-Fredensborg_nedre_hukebak_IMG_0153_rk_166586.JPG", mapQuery: "Damstredet Oslo" },
    { name: "Nobel Peace Center", tag: "Museum",
      desc: "Oslo Pass included — on the harbor front (#6 on the harbor walk).",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Nobel_Peace_Center_12.jpg/960px-Nobel_Peace_Center_12.jpg", mapQuery: "Nobel Peace Center, Oslo" },
  ],
  ...
  Bergen: [
    ...
    { name: "Old Bergen Museum", tag: "Museum",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Gamle_Bergen_Norway_2009_15.jpg/960px-Gamle_Bergen_Norway_2009_15.jpg", mapQuery: "Old Bergen Museum" },
    { name: "Mt. Ulriken", tag: "Nature",
      desc: "Highest mountain around Bergen — great panoramic views.",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Ulriken_Bergen_Norway_02.jpg/960px-Ulriken_Bergen_Norway_02.jpg", mapQuery: "Mount Ulriken, Bergen" },
    { name: "Sandviken Neighborhood", tag: "Neighborhood",
      ...
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Sandviken_Street_Bergen_2009.JPG/960px-Sandviken_Street_Bergen_2009.JPG", mapQuery: "Sandviken Bergen" },
  ],
};
